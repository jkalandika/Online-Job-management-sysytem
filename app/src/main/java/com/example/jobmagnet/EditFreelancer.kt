...
class EditFreelancer : AppCompatActivity() {
    ...
    private fun saveFreelancerDetails(fullName: String, age: Int, contactNumber: String, about: String, interestedJobs: String) {
        ...
        usersRef.orderByChild("email").equalTo(userEmail).addListenerForSingleValueEvent(object :
                    ...
                    for (userSnapshot in dataSnapshot.children) {
                        ...
                        usersRef.child(userId!!).updateChildren(freelancerDetails)
                            ...
                            .addOnFailureListener { exception ->
                                Toast.makeText(this@EditFreelancer, "Failed to save User details: ${exception.message}", Toast.LENGTH_SHORT).show()
                            }
                    }
                }
            }
            ...
            override fun onCancelled(databaseError: DatabaseError) {
                Toast.makeText(this@EditFreelancer, "Error: ${databaseError.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
            ...
            .addOnSuccessListener {
                ref.downloadUrl.addOnSuccessListener { uri ->
                    ...
                    FirebaseDatabase.getInstance().getReference("users")
                        ...
                        .addOnFailureListener { exception ->
                            Toast.makeText(this@EditFreelancer, "Failed to save profile image: ${exception.message}", Toast.LENGTH_SHORT).show()
                        }
                }
            }
            .addOnFailureListener { exception ->
                Toast.makeText(this@EditFreelancer, "Failed to upload image: ${exception.message}", Toast.LENGTH_SHORT).show()
            }
    }
}